...
export enum I18nKey {
  ...
  AUTH$LOGIN_WITH_GOOGLE = "AUTH$LOGIN_WITH_GOOGLE",
  AUTH$OR = "AUTH$OR",
  AUTH$USE_EMAIL = "AUTH$USE_EMAIL",
  AUTH$SIGN_IN_WITH_EMAIL = "AUTH$SIGN_IN_WITH_EMAIL",
  AUTH$YOUR_EMAIL_ADDRESS = "AUTH$YOUR_EMAIL_ADDRESS",
  AUTH$VERIFY = "AUTH$VERIFY",
  AUTH$CANCEL = "AUTH$CANCEL",
  AUTH$ENTER_CODE = "AUTH$ENTER_CODE",
  AUTH$OTP_SENT_MESSAGE = "AUTH$OTP_SENT_MESSAGE",
  AUTH$INVALID_CODE = "AUTH$INVALID_CODE",
  AUTH$NEXT = "AUTH$NEXT",
  AUTH$BACK = "AUTH$BACK",
  AUTH$LOGIN_AS = "AUTH$LOGIN_AS",
  AUTH$ALWAYS_LOGIN_TO_LAST_USED = "AUTH$ALWAYS_LOGIN_TO_LAST_USED",
  AUTH$LOGIN = "AUTH$LOGIN",
  AUTH$REVIEW_TOS = "AUTH$REVIEW_TOS",
  AUTH$REVIEW_TOS_MESSAGE = "AUTH$REVIEW_TOS_MESSAGE",
  AUTH$ACCEPT_TOS = "AUTH$ACCEPT_TOS",
  AUTH$EMAIL_REQUIRED = "AUTH$EMAIL_REQUIRED",
  AUTH$INVALID_EMAIL_FORMAT = "AUTH$INVALID_EMAIL_FORMAT",
